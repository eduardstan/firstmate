...
# The rewrite convergence path also self-heals a deliberately rewritten default
# history only after its positional tree proof and linked-worktree landing checks.
