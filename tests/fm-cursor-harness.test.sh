...
<<<<<<< HEAD
  out=$(env -u PI_CODING_AGENT -u FM_PI_HARNESS -u PRIME_AGENT_CODING_AGENT_DIR -u PRIME_AGENT_INTERNAL_DAEMON_WORKER -u CURSOR_AGENT -u CURSOR_INVOKED_AS PATH="$fakebin:$base_path" \
  ...
  out=$(env -u PI_CODING_AGENT -u FM_PI_HARNESS -u PRIME_AGENT_CODING_AGENT_DIR -u PRIME_AGENT_INTERNAL_DAEMON_WORKER -u CURSOR_AGENT PATH="$fakebin:$base_path" CLAUDECODE=1 \
