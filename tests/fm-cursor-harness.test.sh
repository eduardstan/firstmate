...
test_cursor_marker_outranks_inherited_claudecode() {
  ...
  out=$(env -u PI_CODING_AGENT -u PRIME_AGENT_CODING_AGENT_DIR -u PRIME_AGENT_INTERNAL_DAEMON_WORKER -u FM_PI_HARNESS \
    -u CURSOR_AGENT -u CURSOR_INVOKED_AS CLAUDECODE=1 "$HARNESS")
  ...
  out=$(env -u PI_CODING_AGENT -u PRIME_AGENT_CODING_AGENT_DIR -u PRIME_AGENT_INTERNAL_DAEMON_WORKER -u FM_PI_HARNESS \
        -u CURSOR_AGENT CLAUDECODE=1 CURSOR_API_ENDPOINT=https://example \
