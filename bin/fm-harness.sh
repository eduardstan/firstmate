...
harness_marker() {
  ...
  # and the unmarked Pi result below, because Prime Agent does not clear an
  # inherited CLAUDECODE. It sits BELOW gemini, rovo, and omp deliberately, so
  # their own verified identity keeps winning when nested in Prime Agent.
