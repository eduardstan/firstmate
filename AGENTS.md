...
The verified harnesses are `claude`, `codex`, `opencode`, `pi`, `pi-signed`, `prime-agent`, `grok`, and `kimi`, plus `muse` for crewmates and scouts only; never dispatch on an unverified adapter.
